...
- [x] Start the VM
- [x] Review associated Azure resources

## Screenshots

### Azure VM Created
![Azure VM Created](01-azure-vm-created.png)

### RDP Connection Initiated
![RDP Connection Initiated](02-rdp-connection-initiated.png)

### Windows Server Login
![Windows Server Login](03-windows-server-login.png)
